...
/* harmony import */ var _img_chevron_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../img/chevron.svg */ "./src/img/chevron.svg");
// Imports
...
"use strict";
module.exports = __webpack_require__.p + "images/chevron.svg";
...
"use strict";
module.exports = __webpack_require__.p + "images/img-1.jpg";
...
"use strict";
module.exports = __webpack_require__.p + "images/img-2.jpg";
...
"use strict";
module.exports = __webpack_require__.p + "images/img-3.jpg";
...
/* harmony export */ });
/* harmony import */ var _utils_consts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/consts */ "./src/js/utils/consts.js");
...
class Api {
  ...
  _load({
    url,
    method = _utils_consts__WEBPACK_IMPORTED_MODULE_0__.RequestMethod.GET,
    body = null,
  }) {
  ...
  static checkStatus(response) {
    if (
      response.status < _utils_consts__WEBPACK_IMPORTED_MODULE_0__.SuccessHTTPStatusRange.MIN ||
      response.status > _utils_consts__WEBPACK_IMPORTED_MODULE_0__.SuccessHTTPStatusRange.MAX
    ) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CardsModel)
/* harmony export */ });
/* harmony import */ var _observer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./observer */ "./src/js/model/observer.js");


class CardsModel extends _observer__WEBPACK_IMPORTED_MODULE_0__.default {
  constructor() {
    super();
...
/***/ "./src/js/presenter/board-presenter.js":
/*!*********************************************!*\
  !*** ./src/js/presenter/board-presenter.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/presenter/card-presenter.js":
/*!********************************************!*\
  !*** ./src/js/presenter/card-presenter.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _view_cards_card_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/cards/card-view */ "./src/js/view/cards/card-view.js");
...
class CardPresenter {
  ...
  init(card) {
    ...
    this._component = new _view_cards_card_view__WEBPACK_IMPORTED_MODULE_0__.default(this._card);

    if (prevCardComponent === null) {
      (0,_utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.render)(this._cardListContainerElement, this._component, _utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.RenderPosition.BEFOREEND);
      return;
    }

    if (this._cardListContainerElement.contains(prevCardComponent.getElement())) {
      (0,_utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.replace)(this._component, prevCardComponent);
    }

    (0,_utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.remove)(prevCardComponent);
  }

  destroy() {
    (0,_utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.remove)(this._component);
  }
}
...
/***/ "./src/js/presenter/filter-presenter.js":
/*!**********************************************!*\
  !*** ./src/js/presenter/filter-presenter.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class FilterPresenter {
  ...
  init() {
    ...
    this._component = new _view_filter_view__WEBPACK_IMPORTED_MODULE_0__.default(filterValue);
    this._component.setFilterValueChangeHandler(this._handleFilterValueChange);

    (0,_utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.render)(this._container, this._component, _utils_render_utils__WEBPACK_IMPORTED_MODULE_1__.RenderPosition.BEFOREEND);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CARDS_COUNT_PER_STEP": () => (/* binding */ CARDS_COUNT_PER_STEP),
/* harmony export */   "UpdateTypeForRerender": () => (/* binding */ UpdateTypeForRerender),
/* harmony export */   "RequestMethod": () => (/* binding */ RequestMethod),
/* harmony export */   "SuccessHTTPStatusRange": () => (/* binding */ SuccessHTTPStatusRange)
/* harmony export */ });
const CARDS_COUNT_PER_STEP = 6;

const UpdateTypeForRerender = {
  MAJOR: `MAJOR`,
  INIT: `INIT`,
};
...
/* harmony export */ });
/* harmony import */ var _view_abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/abstract */ "./src/js/view/abstract.js");
...
class Abstract {
  ...
  getElement(selector = ``) {
    if (!this._elementHTML) {
      this._elementHTML = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.createElementHTML)(this.getTemplate());
    }
...
/***/ "./src/js/view/cards/card-view.js":
/*!****************************************!*\
  !*** ./src/js/view/cards/card-view.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _smart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../smart */ "./src/js/view/smart.js");
...
const createFilmCardTemplate = (card) => {
  ...
  return `<li class="card">
            <a class="card__link" href="/details/${id}">
              ...
              <div class="card__description card__description_${type.toLowerCase()}">
                ...
                <p class="card__properties">
                  New Properties for Sale from <span class="card__properties_sign">£</span><span class="card__properties_price">${(0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.numberWithCommas)(price)}</span>
                </p>
...
class CardView extends _smart__WEBPACK_IMPORTED_MODULE_0__.default {
  constructor(card) {
    super();
    this._card = card;
  }
...
class CardsListView extends _abstract__WEBPACK_IMPORTED_MODULE_0__.default {
  getTemplate() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ NoCardsView)
/* harmony export */ });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstract */ "./src/js/view/abstract.js");
...
class NoCardsView extends _abstract__WEBPACK_IMPORTED_MODULE_0__.default {
  getTemplate() {
...
const createFilterTemplate = (filterData) => {
  ...
  return `<input class="header__filter" id="filter" name="filter" type="text" value="${he__WEBPACK_IMPORTED_MODULE_1___default().encode(text)}">`;
};

class FilterView extends _smart__WEBPACK_IMPORTED_MODULE_0__.default {
  constructor(data) {
    super();
    this._data = data;
...
class LoadingView extends _abstract__WEBPACK_IMPORTED_MODULE_0__.default {
  getTemplate() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SeeMoreView)
/* harmony export */ });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/js/view/abstract.js");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _img_chevron_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/chevron.svg */ "./src/img/chevron.svg");
/* harmony import */ var _img_img_1_jpg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./img/img-1.jpg */ "./src/img/img-1.jpg");
/* harmony import */ var _img_img_2_jpg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./img/img-2.jpg */ "./src/img/img-2.jpg");
/* harmony import */ var _img_img_3_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./img/img-3.jpg */ "./src/img/img-3.jpg");
/* harmony import */ var _sass_style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sass/style.scss */ "./src/sass/style.scss");
/* harmony import */ var _js_presenter_filter_presenter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/presenter/filter-presenter */ "./src/js/presenter/filter-presenter.js");
/* harmony import */ var _js_model_filter_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/model/filter-model */ "./src/js/model/filter-model.js");
/* harmony import */ var _js_model_cards_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/model/cards-model */ "./src/js/model/cards-model.js");
/* harmony import */ var _js_api_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/api/api */ "./src/js/api/api.js");
/* harmony import */ var _js_presenter_board_presenter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/presenter/board-presenter */ "./src/js/presenter/board-presenter.js");
/* harmony import */ var _js_utils_consts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/utils/consts */ "./src/js/utils/consts.js");
...
const filterModel = new _js_model_filter_model__WEBPACK_IMPORTED_MODULE_6__.default();
const cardsModel = new _js_model_cards_model__WEBPACK_IMPORTED_MODULE_7__.default();

const boardPresenter = new _js_presenter_board_presenter__WEBPACK_IMPORTED_MODULE_9__.default(siteMainElement, cardsModel, filterModel);

const filterPresenter = new _js_presenter_filter_presenter__WEBPACK_IMPORTED_MODULE_5__.default(siteHeaderElement, filterModel);
const END_POINT = `https://603e38c548171b0017b2ecf7.mockapi.io`;

const api = new _js_api_api__WEBPACK_IMPORTED_MODULE_8__.default(END_POINT);
...
api.getCards()
  .then((cards) => {
    cardsModel.setItems(_js_utils_consts__WEBPACK_IMPORTED_MODULE_10__.UpdateTypeForRerender.INIT, cards);
  })
  .catch(() => {
    cardsModel.setItems(_js_utils_consts__WEBPACK_IMPORTED_MODULE_10__.UpdateTypeForRerender.INIT, []);
  });
