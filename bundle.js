...
/* harmony export */   "UserActionForModel": () => (/* binding */ UserActionForModel),
...
const BASE = 10; // the base in mathematical numeral systems

const UserActionForModel = {
  ADD_ITEM: `ADD_ITEM`,
...
const createFilmCardTemplate = (card) => {
  ...
  return `<li class="card card__${type.toLowerCase()}">
            <a class="card__link" href="#">
              ...
              <div class="card__description card__description_independent">
                <h3 class="card__title">${title}</h3>
                <p class="card__address">
                  ${address}
                </p>
                <p class="card__properties">
                  New Properties for Sale from <span class="card__properties_price">${price}</span>
                </p>
